/* $Id: util.c,v 1.44.2.6.2.7 2005/09/16 21:06:35 roesch Exp $ */
/*
...
#ifdef TIMESTATS
extern long start_time;   /* used for processing run time and packets per second stats */
