; $Id: snort_installer.nsi,v 1.9.2.1.2.4 2005/10/17 12:53:25 ssturges Exp $
;
; NSIS Installation script for Snort 2.4.3 Win32
; Written by Chris Reid <chris.reid@codecraftconsultants.com>
;
; This script will create a Win32 installer for Snort 2.4.3 (Win32 only).
