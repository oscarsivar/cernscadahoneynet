/* $Id: config.h,v 1.32.2.6.2.5 2005/10/17 12:53:25 ssturges Exp $ */
 ...
 */
#define VERSION "2.4.3"VERSION_ENABLE_ODBC""VERSION_ENABLE_MYSQL""VERSION_ENABLE_MSSQL""VERSION_ENABLE_ORACLE""VERSION_ENABLE_RESPONSE"-WIN32"VERSION_DEBUG
