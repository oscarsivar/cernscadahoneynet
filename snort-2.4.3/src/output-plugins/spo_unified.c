...
/* $Id: spo_unified.c,v 1.44.2.1.2.5 2005/07/11 14:41:40 ssturges Exp $ */
       ...
       if(p->packet_flags & PKT_REBUILT_STREAM)
        {
           ...
           if(spd != NULL )
           {
              alertdata.ts.tv_sec  = spd->pkth.ts.tv_sec;
              alertdata.ts.tv_usec = spd->pkth.ts.tv_usec;
          } 
       }
        ...
        while (spd != NULL )
        {
            ...
            if(spd->chuck != SEG_UNASSEMBLED)
            {
               ...
               /*  Set reference time equal to log time for the first packet  */
                ...
                logheader.event.event_id = ++event_id | pv.event_log_id;
            }
