...
#define HONEYD_SYN_WAIT		30
#define HONEYD_IDLE_TIMEOUT	60
...
void honeyd_ip_send(u_char *, u_int);
...
void icmp_echo_reply(struct template *, struct ip_hdr *, uint8_t,
    uint8_t, uint16_t, uint8_t,	u_char *, u_int);
