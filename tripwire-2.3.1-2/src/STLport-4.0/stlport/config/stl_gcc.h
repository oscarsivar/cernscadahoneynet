...
/* gcc has weird problems in debug mode */
#   define __STL_NAMESPACE_FUNCTION_AMBIGUITY_BUG 1

#   define __STL_HAS_NO_NEW_C_HEADERS     1

# if defined(__FreeBSD__)
#  define __STL_NATIVE_CPP_C_INCLUDE_PATH /usr/include/g++
	/* Emulate a small wchar.h */
#  include <sys/types.h>
#  define _WCHAR_T
#  define _WINT_T
...
#  define __STL_NATIVE_CPP_C_INCLUDE_PATH /usr/include/g++
#  define __STL_UNIX			/* Yes, OpenBSD is Unix-like */
#  define _NOTHREADS			/* Has no pthread capabilities */
#  include <sys/types.h>		/* Necessary for __P() macro */
	/* Emulate a small wchar.h */
#  define _WCHAR_T
#  define _WINT_T
   typedef unsigned int wint_t;
...
// I expect "g++-3" not being used in leter releases.
